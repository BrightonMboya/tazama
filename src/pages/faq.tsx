  ...
  return (
    <>
      ...
      <div className="mx-auto mt-48 max-w-5xl px-4 py-20 md:px-8 lg:mt-5 lg:py-10">
        <p className="mx-auto max-w-4xl p-4 text-center text-xl text-darker/85">
        ...
        <div className="mt-10 flex flex-col items-start gap-4 text-darker/85 md:flex-row md:gap-8">
          <aside className="w-full md:w-1/3">
            ...
            <ul className="font-raleway flex flex-col items-start gap-2 md:gap-5">
              <li
                className={`font-raleway cursor-pointer text-sm hover:text-primary hover:underline focus:underline active:underline sm:text-base ${
              ...
              <li
                className={`font-raleway cursor-pointer text-sm hover:text-primary hover:underline sm:text-base ${
                  category !== "safari" ? "text-primary" : ""
                }`}
