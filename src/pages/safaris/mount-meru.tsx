...
const Page = ({ images }: { images: ImageProps[] }) => {
  return (
    <>
      ...
      <div className="mx-auto  max-w-5xl px-4 md:px-8 my-16">
        <div className=" py-8">
        ...
        <div className="pb-10">
          {/* <h3 className="text-4xl text-primary">Sundowners in nature</h3> */}
          <p className="mb-3 text-xl text-darker/85">
        ...
        <h4 className="text-4xl mt-16 mb-6">Our Mount Meru Gallery</h4>
