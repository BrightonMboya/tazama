          ...
          <div className="mx-auto  px-4 md:px-8 lg:mx-0 lg:max-w-[60%] lg:text-justify">
            <div className="mb-10 py-8">
              ...
              <p className="mb-3 mt-5 text-xl text-[#757371]">
                ...
                to guide you through every step of your training, ensuring
                you're fully equipped for the ascent.
              </p>{" "}
              <p className="mt-5 text-2xl font-bold text-primary">
              ...
              <p className="mb-3 mt-5 text-xl text-[#757371]">
                ...
                build endurance, strength, and adaptability to varied terrains
                and altitudes. Begin your physical training at least four weeks
                before your climb if you're already active; if you're starting
                from a lower base of fitness, give yourself two months or more
                to prepare.
              </p>
              ...
              <p className="mb-3 mt-5 text-xl text-[#757371]">
                ...
                diverse paths. Aim for long hikes at least once a week,
                gradually increasing the distance and carrying a weighted
                backpack to simulate climbing conditions.
              </p>
              <p className="mb-3 mt-5 text-xl text-[#757371]">
              ...
              <p className="mb-3 mt-5 text-xl text-[#757371]">
                ...
                cycling, and swimming can enhance your lung capacity and
                stamina.
              </p>
              <div className="relative mt-[50px] h-[400px] w-full lg:hidden lg:w-[50%]">
                <Image
              ...
              <p className="mb-3 mt-5 text-xl text-[#757371]">
                The journey to Kilimanjaro's summit is as much a mental
                challenge as it is a physical one. Preparing your mind for the
                days ahead is crucial for overcoming the inevitable hurdles of
                high-altitude climbing.
              </p>
              <p className="mb-3 mt-5 text-xl text-[#757371]">
                <span className="text-primary">Visualization: </span>
                Regularly visualize yourself successfully navigating the climb
                and reaching the summit. This mental rehearsal can build
              ...
              <p className="mb-3 mt-5 text-xl text-[#757371]">
                ...
                milestone, whether it's completing a challenging training hike
                or reaching a new elevation during your ascent.
              </p>
              <p className="mt-5 text-2xl font-bold text-primary">
              ...
              <p className="mb-3 mt-5 text-xl text-[#757371]">
                ...
                preferably on hilly terrain. Continue strength training and
                focus on your mental preparation strategies.
              </p>
              <p className="mb-3 mt-5 text-xl text-[#757371]">
                <span className="text-primary">Week Before Climb: </span>
                Taper your training to allow your body to rest and recover.
                Focus on nutrition, hydration, and mental preparation.
              </p>
              <p className="mb-3 mt-5 text-xl text-[#757371]">
                Training for Kilimanjaro is a journey that prepares you not just
                for the climb but for a transformative life experience. Tazama
                is with you every step of the way, providing expert guidance,
