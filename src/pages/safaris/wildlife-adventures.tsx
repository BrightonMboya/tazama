  ...
  return (
    <>
      ...
      <div className="mx-auto mt-10 max-w-5xl px-4 pt-[2rem]">
        <div className="">
          <h3 className="text-4xl text-primary">Wildlife Adventures</h3>
      ...
      <div className="mx-auto mt-10 max-w-5xl px-4 pt-[2rem]">
        <div className="">
          <h3 className="text-4xl text-primary">Tarangire National Park</h3>
          <p className="mb-3 mt-5 text-darker/85">
      ...
      <div className="mx-auto mt-10 max-w-5xl px-4 pt-[2rem]">
        <div className="">
          <h3 className="text-4xl text-primary">Lake Manyara trip</h3>
          <p className="mb-3 mt-5 text-darker/85">
          ...
          <p className="mb-3 mt-5 text-darker/85">
            ...
            <br />
            <br />
            <span className="font-serif text-3xl text-primary mt-6">What to expect</span>
            <br />
