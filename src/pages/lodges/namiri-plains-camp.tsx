    ...
    return (
        <>
            ...
            <div className='my-20 max-w-5xl mx-auto md:px-8 px-4'>
                <section>
                    <h3 className="text-5xl text-center mb-4">Namiri Plains Camp</h3>
                    <p>
                    ...
                    <div className='grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8'>
                        {
                            [1,5,3,4,2,6,7].map(img => (
                                <div key={img} className="w-full h-60">
                                    <img src={`/assets/images/gallery/lodges/namiri-plains/gallery/${img}.jpg`} alt={`Siringit Image ${img}`} className='w-full h-full object-cover' />
                                </div>
                            ))
                        }
                    </div>
