...
export default function PlanMyTrip() {
  ...
  return (
    <Dialog onOpenChange={setDialopOpen} open={dialopOpen}>
      <DialogTrigger
        asChild
        className={` bg-[#A87133] px-2 py-1 font-raleway font-medium text-white`}
      >
        <Button
          className={`menu-trigger flex items-center gap-2 rounded-md bg-[#A87133] px-2 text-white transition duration-200 ease-in-out md:gap-3 md:px-3 md:py-5`}
          onClick={() => {
      ...
      <DialogPortal>
        <DialogContent
          className={`h-screen md:h-[80vh] bg-lightest font-raleway sm:max-w-[80%] lg:h-[70%] lg:w-[60%] ${raleway.variable}`}
          style={{
