export default function Head() {
  return (
    <head>
      <script
        async
        src="https://www.googletagmanager.com/gtag/js?id=G-Y1V1WEYTND"
      ></script>
      {/* <script>
    ...
    gtag('config', 'G-Y1V1WEYTND');
      ...
      {/* <meta itemprop="name" content="Tazama Africa Tours and Safaris" />
  <meta itemprop="url" content="https://www.tazamaafricasafari.com" />
